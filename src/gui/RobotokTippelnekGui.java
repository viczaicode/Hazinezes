...
public class RobotokTippelnekGui extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel5Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel5Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(btnGeneral, javax.swing.GroupLayout.PREFERRED_SIZE, 23, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    private void btnGeneralActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGeneralActionPerformed
        ...
        int also = (int) numMin.getValue();
                ...
                if (felso < also) {
                    ...
                    JOptionPane.showMessageDialog(rootPane, "Mivel a minimun nagyobb volt mint a maximum, ezért megfordítottam az értékeiket!");
                }
                
                int db = felso - also + 1;
                szam1 = veletlenSzam(felso, also);
    ...
    private int veletlenSzam(int felso, int also) {
        int szam1;
        szam1 = (int) (Math.random() * felso) + also;
        return szam1;
    }
    ...
    private void kilepes() {
        String uzenet = "Biztosan kilép?";
        String cim = "KILÉPÉS";
        int gombok = JOptionPane.OK_CANCEL_OPTION;
        //int tipus = JOptionPane.QUESTION_MESSAGE;
        int kilepes = JOptionPane.showConfirmDialog(rootPane, uzenet, cim, 2);
